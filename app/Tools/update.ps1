...
function Root {
$parentPath = Split-Path -parent "C:\Users\micha\Desktop\app\Tools\update.ps1"
...
$yes.Add_Click({
    ...
    echo "Start-Sleep -Seconds 5; Rm -Path $Env:USERPROFILE\Desktop\p2d-temp, $Env:USERPROFILE\Desktop\erase.ps1 -Recurse -Force" > $Env:USERPROFILE\Desktop\erase.ps1
    powershell -w h -NoP -NonI -Exec Bypass $Env:USERPROFILE\Desktop\erase.ps1
    Copy-Item $Env:USERPROFILE\Desktop\p2d-temp\$NF\$FF $Base -Force -Recurse
