...
$MenuBar.Items.AddRange(@($fileToolStripMenuItem,$logsToolStripMenuItem,$socialToolStripMenuItem))
...
function OnClick_logsToolStripMenuItem(){notepad "$Root\Version\log.txt"}
