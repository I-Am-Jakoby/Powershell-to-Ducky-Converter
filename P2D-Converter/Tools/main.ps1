...
#$myFile =  "C:\Users\micha\Desktop\P2D-Converter\Tools\main.ps1"
...
$BGImage                              = [system.drawing.image]::FromFile("$Root\Assets\p2d-gui.png")
...
$help.Add_Click({
Start-Process "https://github.com/I-Am-Jakoby/PowerShell-for-Hackers"
})
#-------------------------------------------------------------------------------------------------------
