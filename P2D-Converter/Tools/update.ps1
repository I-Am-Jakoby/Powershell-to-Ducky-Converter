...
$yes.Add_Click({
    ...
    echo "Copy-Item $Env:USERPROFILE\Desktop\p2d-temp\$NF\$FF $Base -Force -Recurse; Rm -Path $Env:USERPROFILE\Desktop\p2d-temp, $ZipFile, $Env:USERPROFILE\Desktop\erase.ps1; powershell -w h -NoP -NonI -Exec Bypass $Root\Tools\main.ps1 -Recurse -Force" > $Env:USERPROFILE\Desktop\erase.ps1
